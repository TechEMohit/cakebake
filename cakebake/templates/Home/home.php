<?php
    $this->assign("title",'Admin Panel | Home');
    $this->start('page-css'); ?>
 <?= $this->Html->css("plugins/apex/apexcharts.css") ?>
    <?= $this->Html->css("assets/css/dashboard/dash_1.css") ?>
<?php $this->end() ?>
...
<?php
    ...
    <?= $this->Html->script('apex/apexcharts.min.js') ?>
    <?= $this->Html->script('js/dashboard/dash_1.js') ?>
    <!-- BEGIN PAGE LEVEL PLUGINS/CUSTOM SCRIPTS -->
   <?php $this->end(); ?>