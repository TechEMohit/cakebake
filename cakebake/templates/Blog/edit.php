            ...
            <div class="statbox widget box box-shadow">
               ...
               <div class="widget-content widget-content-area">
                ...
                <?php
                 ...
                 echo $this->Form->control('Title',['name' => 'title','value' => $blog->title ,'class' => "form-control mb-3",'placeholder'=>'name@example.com']); 
                 ...
                 echo $this->Form->control('Description',['name' => "description",'value'=> $blog->description ,'type' =>"textarea",'class'=>'form-control mb-3']);
