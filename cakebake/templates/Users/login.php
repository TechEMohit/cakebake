            ...
            <div class="form-form-wrap">
                <div class="form-container">
                    <div class="form-content">
                        ...
                        <h1 class=""><img src="<?= $baseurl ?>webroot/img/logo.png"></h1>
                        <p class="">Log in to your account to continue.</p>
                        <span class="text-danger"><?= $this->Flash->render() ?></span>
                        <?= $this->Form->create() ?>
                        <div class="text-left">
                            <div class="form">
                                ...
                                <div id="username-field" class="field-wrapper input">
                                    ...
                                    <?php echo $this->Form->control("",["name" => "email",'class' => "form-control",'placeholder' =>"e.g John_Doe"]) ?>
                                ...
                                <div id="password-field" class="field-wrapper input mb-2">
                                    ...
                                    <?php echo $this->Form->control("",["name" => "password","type" =>"text",'class' => "form-control",'placeholder' =>"Password"]) ?>
